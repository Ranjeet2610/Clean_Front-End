...
const MatchOddsTable = (props) => {
    ...
    const [state, setstate] = useState({
        ...
        ...{
            ...
            expoDBetProfit:props?.expoDBetProfit,
            expoDBetLoss:props?.expoDBetLoss,
            SoM:props?.SoM,
                            ...
                            state.runners?.map((item, index) => {
                                ...
                                if (filterrunners?.length > 0) {
                                                ...
                                                <td colSpan="7">
                                                    <div className="mobileBetBox">
                                                        <BetBox
                                                            ...
                                                            expoDBetProfit={state.expoDBetProfit}
                                                            expoDBetLoss={state.expoDBetLoss}
                                    ...
                                    return (
                                        ...
                                        <tr id="user_row0" class="back_lay_color runner-row-32047099">
                                        <td>
                                            <p class="runner_text" id="runnderName0">The Draw</p>
                                            <p class="blue-odds" id="Val1-117138930632047099">0</p>
                                            {
